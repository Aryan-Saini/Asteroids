...
public class Space extends World
{
    ...
    private final int START_ASTEROIDS = Greenfoot.getRandomNumber(10);

    /**
     * Space is the constructor for Space type objects
     * 
     ...
     */
    /**
     * paintStarts paints the background with as many stars specifies in the parameter count
     * 
     * @param count is a int parameter (thats referenced) to how many stars should be painted
     * @return nothing is returned
     */
     ...
     */
    /**
     * addAsteroids adds as many Asteroids specified in the count parameter
     * 
     * @param count is a int pramter (thats referenced) to how many asterdois should be added to the world
     * @return nothing is returned
     */

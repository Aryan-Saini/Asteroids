...
public class Asteroid extends SmoothMover
{
     ...
     */
    /**
     * setSize sets the size of the Asteroid image
     * 
     * @param size is a int data type (thats referenced) to the size of the image when called
     * @return nothing is returned
     */
     ...
     */
    /**
     * hit is the method  that checks if the asteroid has been hit
     * 
     * @param damage is a int type data base (thats referenced) to how much damage is being done
     * @return nothing is returned
     */
     ...
     */
    /**
     * breakUp breaks the asteroid into multiple diffrent peces deponding on the numBreakUp
     * 
     * @param numBreakUp is a int data base (thats referenced) how much pices its broken into
     * @return nothing is returned
     */
